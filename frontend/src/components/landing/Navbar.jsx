            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden lg:flex items-center space-x-3">
                        <button className="px-5 py-2.5 text-gray-300 hover:text-white transition-colors duration-300 text-sm font-medium">
                            Sign in
                        </button>
                        <button className="relative group px-6 py-2.5 rounded-xl font-medium text-sm text-white overflow-hidden transition-all duration-300 hover:scale-105">
                ...
                <div className="lg:hidden bg-gray-950/95 backdrop-blur-2xl border-t border-white/5">
                    <div className="px-6 py-6 space-y-4">
                        ...
                        <div className="pt-4 space-y-3 border-t border-white/5">
                            <button className="w-full text-gray-300 hover:text-white py-3 text-base font-medium transition-colors">
                                Sign in
                            </button>
                            <button className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white px-6 py-3 rounded-xl text-base font-medium transition-all shadow-lg shadow-indigo-500/30">
                                Get Started
                            </button>
                        </div>
                    </div>
